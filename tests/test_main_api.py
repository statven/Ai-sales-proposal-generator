...
def patch_doc_and_db_and_ai(monkeypatch):
    ...
    # Keep this patch for modules that might import it directly
    ...
    # Mock doc_engine in main's namespace (THIS IS THE ACTIVE MOCK FOR GENERATE_PROPOSAL)
...
def test_generate_proposal_rendering_failure_raises_500(monkeypatch):
    ...
    # ИСПРАВЛЕНО: Нацеливаемся на метод на активном мок-объекте в main.py
